...
fun PromoBannerGm4(onDismiss: () -> Unit, modifier: Modifier = Modifier) {
  ...
  Box(modifier = modifier) {
    ...
    Column(
      ...
      Text(text = stringResource(R.string.banner_gm4_title), style = MaterialTheme.typography.titleMedium)
      Text(
        stringResource(R.string.banner_gm4_description),
      ...
      Row(
        ...
        TextButton(onClick = onDismiss, contentPadding = BUTTON_PADDING) { Text(stringResource(R.string.promo_dismiss)) }
        Button(
          ...
          Text(stringResource(R.string.banner_read_more))
        }
      }
    }
  }
