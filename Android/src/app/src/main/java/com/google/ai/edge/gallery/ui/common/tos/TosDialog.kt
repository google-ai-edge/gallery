        ...
        Column(modifier = Modifier.verticalScroll(rememberScrollState()).weight(1f, fill = false)) {
          ...
          MarkdownText(
            "To use Google AI Edge Gallery, you accept " +
              ...
              "establish what you can expect from us as you use our services, and what we expect " +
              "from you.",
            smallFontSize = true,
          ...
          if (viewFullTerms) {
            MarkdownText(
              "In addition, your use of any Gemma models in the Google AI Edge Gallery app is " +
                ...
                "\n" +
                "Your use of any other AI models in Google AI Edge Gallery is subject to the " +
                "terms and conditions that apply to that model. Please read those terms " +
                "carefully before using any third-party model.\n" +
                "\n" +
