package com.smartscreenshot.organizer.ui.theme
...
// ── Category Colors ─────────────────────────────────────────────────────
val CategoryShopping = Color(0xFFFF8A65)
val CategoryReceipts = Color(0xFF4DB6AC)
val CategoryChat = Color(0xFF64B5F6)
val CategorySocialMedia = Color(0xFFBA68C8)
val CategoryBanking = Color(0xFF81C784)
val CategoryTravel = Color(0xFFFFD54F)
val CategoryWork = Color(0xFF90A4AE)
val CategoryCoding = Color(0xFFA1887F)
val CategoryMemes = Color(0xFFE57373)
val CategoryDocuments = Color(0xFF7986CB)
val CategoryOther = Color(0xFFBDBDBD)
